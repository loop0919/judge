...
files = [str(Path('/opt/judge') / name) for name in
         ('host.py', 'sandbox.py', 'interactive.py', 'worker.py', 'runtimes.py', 'smoke.py', 'interactive_smoke.py', 'testlib_smoke.py', 'language-smoke.json', 'sandbox-etc/passwd', 'sandbox-etc/group')]
