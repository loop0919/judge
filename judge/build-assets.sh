...
cp host.py sandbox.py interactive.py interactive_smoke.py testlib_smoke.py worker.py smoke.py install.sh fingerprint.py smoke.sh judge-worker.service runtimes.py language-smoke.json "$build_dir/"
