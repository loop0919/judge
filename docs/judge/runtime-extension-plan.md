...
2026-09-14に実装・配布・実機検証を完了し、12言語を公開した。
採用値は以下に、全14ランタイムの実機smokeと本番APIの検証提出16件の結果は[適用記録](runtime-rollout.md)に記録する。
...
実装前のsmokeには、Java 24だけを識別する分岐や、未分類言語をPythonとして扱う分岐があった。
