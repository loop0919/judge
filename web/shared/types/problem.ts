...
export const publicProblemSchema = publicProblemSummarySchema.extend({ markdown: z.string().min(1), timeLimitMs: z.coerce.number().int().positive(), memoryLimitMb: z.coerce.number().int().positive() })
