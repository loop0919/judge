...
<template>
  <article class="blog-article">
    ...
    <nav class="blog-toc" aria-label="記事の目次"><a href="#structure">基本の書き方</a><a href="#inline-math">文中の数式</a><a href="#input-format">入力形式</a><a href="#display-math">独立した数式</a><a href="#samples">入出力例</a><a href="#details">折りたたみ</a><a href="#judge-status">ジャッジステータス</a><a href="#drafts">下書きと保存</a></nav>
