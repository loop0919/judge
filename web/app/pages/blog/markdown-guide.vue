...
<template>
  <article class="blog-article">
    ...
    <section id="drafts"><h2>下書きを保存する</h2><p>編集した下書きは、このブラウザーに自動保存されます。「下書きを保存」ボタンでも保存できます。記事を読み終えて作成ページに戻ると、保存した下書きを復元します。</p><p>保存した問題は「自分の問題」から一覧で確認し、編集を再開できます。「新しい問題を作成」から別の下書きを作成できます。保存先はこのブラウザーで、別の端末とは共有されません。サイトデータを削除すると下書きも消えます。</p><p>下書きを保存しても、問題は公開されません。</p></section>
